...
const productsUrl = "https://aqueous-thicket-88603.herokuapp.com/productos"; //prod
...
export const editProduct = async (product) => {
    ...
    return await axios.put(`${productsUrl}/editar/${product._id}`, product, { headers: authHeaders });
}